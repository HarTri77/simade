...
use App\Http\Controllers\PembelianBumdesController;
use App\Http\Controllers\Admin\PesananBumdesController;
...
Route::get('/bumdes/{slug}', [BumdesController::class, 'show'])->name('bumdes.detail');
...
Route::get('/bumdes/{id}/beli', [PembelianBumdesController::class, 'create'])->name('pembelian.create');
Route::post('/pembelian', [PembelianBumdesController::class, 'store'])->name('pembelian.store');
